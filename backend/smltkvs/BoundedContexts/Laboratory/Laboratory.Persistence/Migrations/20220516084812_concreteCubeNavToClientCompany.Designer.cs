...
namespace Laboratory.Persistence.Migrations
{
    ...
    [Migration("20220516084812_concreteCubeNavToClientCompany")]
    partial class concreteCubeNavToClientCompany
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Laboratory.Domain.Aggregates.ConcreteCubeStrengthTest", b =>
                {
                    ...
                    b.Property<Guid>("ClientConstructionSiteId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Laboratory.Domain.Aggregates.ConcreteCubeStrengthTest", b =>
                {
                    b.HasOne("Laboratory.Domain.Aggregates.Company", "ClientCompany")
                        .WithMany()
